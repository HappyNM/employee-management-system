...
export const DepartmentButtons = ({_id, onDepartmentDelete})=>{
    ...
    const handleDelete = async (id)=>{
        ...
        if(confirm){
              try {
                const response = await axios.delete(`https://employee-server-pink.vercel.app/api/department/${id}`, {
                  headers: {
    ...
    return (
        <div>
            <button className='bg-teal-600 text-white px-2 py-1 rounded mr-2'
