      ...
      <div>
        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input type="text" name="dep_name" placeholder='Department Name' className='mt-1 w-full p-2 border border-gray-300 rounded-md' onChange={handleChange} value={department?.dep_name || ''} required/>
          </div>
          <div className='mt-3'>
            <label htmlFor="description" className='block text-sm font-medium text-gray-700'>Description</label>
            <textarea name="description" placeholder='Enter Description' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' rows="4" onChange={handleChange} value={department?.description || ''}/> 
          </div>
