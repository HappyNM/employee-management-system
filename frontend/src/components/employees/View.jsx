                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors duration-200">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-lg font-bold text-gray-800">{employee.userId.name}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors duration-200">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-lg font-bold text-gray-800 break-all">{employee.userId.email}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors duration-200">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-lg font-bold text-gray-800">{new Date(employee.dob).toLocaleDateString()}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors duration-200">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-lg font-bold text-gray-800">{employee.department.dep_name}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors duration-200">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-lg font-bold text-gray-800">KES {employee.salary.toLocaleString()}</div>
                                        </div>
                                    </div>
